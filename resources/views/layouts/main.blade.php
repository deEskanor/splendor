...
<div class="super_container">
    ...
    <header class="header">
                ...
                <div class="row">
                    <div class="col">
                        <div class="header_content d-flex flex-row align-items-center justify-content-start">
                            <div class="logo"><a href="{{route('Home')}}">Splendor.</a></div>
                            <nav class="main_nav">
                                <ul>
        ...
        <div class="header_social">
            <ul>
                ...
                <li><a href="https://www.instagram.com/splendor.clth/"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
    ...
    <footer class="footer">
        <div class="footer_background" style="background-image:url(images/1400x350&text=1400x350.png)"></div>
        <div class="container">
            <div class="row">
                <div class="col">
