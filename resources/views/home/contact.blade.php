                ...
                <div class="col-lg-3 offset-xl-1 contact_col">
                    <div class="contact_info">
                        <div class="contact_info_section">
                            ...
                            <ul>
                                <li>Phone: <span>+53 068 1225 4660</span></li>
                                <li>Email: <span>Volodymyr.Hural@gmail.com</span></li>
                            </ul>
                        </div>
                        <div class="contact_info_section">
                            <div class="contact_info_title">Shippiing & Returns</div>
                            <ul>
                                <li>Phone: <span>+53 500 4290 6970</span></li>
                                <li>Email: <span>Mykyta.Datsko@gmail.com</span></li>
                            </ul>
                        </div>
                        <div class="contact_info_section">
                            ...
                            <ul>
                                ...
                                <li>Email: <span>Danylo.Zemba@gmail.com</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
